    ...
    @section('content')
                                    ...
                                    <dialog id="editcategory" class="rounded-lg shadow-xl p-0 w-full max-w-md">
                                        <div class="bg-white rounded-lg overflow-hidden">
                                            <div
                                                ...
                                                <h3 class="text-lg font-semibold" id="categoryPopupTitle">Edit Category
                                                </h3>
                                            ...
                                            <form id="categoryForm"
                                                ...
                                                <div class="mb-4">
                                                    <label for="categoryName"
                                                        class="block text-gray-700 font-bold mb-2">Category Name</label>
            ...
            <div class="bg-white rounded-lg overflow-hidden">
                ...
                <form id="flowerForm" action="{{ route('products.store') }}" method="POST" class="p-4"
                    ...
                    <div class="mb-4">
                        ...
                        <select id="flowerCategory" name="category_id" class="w-full px-3 py-2 border rounded-md"
                            required>
                    ...
                    <div class="mb-4">
                        <label for="flowerImages" class="block text-gray-700 font-bold mb-2">Images</label>
                        <input type="file" id="flowerImages" name="images[]"
                            class="w-full px-3 py-2 border rounded-md" multiple required>
                    </div>
                    <div class="flex justify-end">
        ...
        <dialog id="categoryPopup" class="rounded-lg shadow-xl p-0 w-full max-w-md">
            <div class="bg-white rounded-lg overflow-hidden">
                ...
                <form id="categoryForm" action="{{ route('categories.store') }}" method="POST" class="p-4"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" id="images" name="images[]" class="w-full px-3 py-2 border rounded-md"
                            multiple>
                    </div>
                    <div class="flex justify-end">
                        <button type="button" onclick="closeCategoryPopup()"
